...
// konfigutacja pytañ
//lvl1
$question[1] = 'Osoba na zdjêciu to?';
$img[1]      = '<img src="img/image.PNG" alt="obrazek" />';// If no image leave empty
$passwds[1]  = array(
	"haslo1",
	"haslo2",
	"haslo3"
);
$question[2] = 'Osoba na zdjêciu to?';
$img[2]      = '<img src="img/image.PNG" alt="obrazek" />';// If no image leave empty
$passwds[2]  = array(
	"haslo1",
	"haslo2",
	"haslo3"
